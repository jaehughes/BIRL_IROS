...
def get_angles(x,y):
    ...
    y2 = y*y
    r = math.sqrt(x2+y2)
    t1 = 90.0 - math.atan(x/y)
    t2 = 2*math.atan(((392400*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) + 1640*r + ((x2 + y2)*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) - (600*r*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) - 492000)/(x2 - 600*r + y2 + 459600))
    t3 = 2*math.atan((math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000)/(x2 - 600*r + y2 + 392400)) - 2*math.atan(((392400*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) + 1640*r + ((x2 + y2)*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) - (600*r*(math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000))/(x2 - 600*r + y2 + 392400) - 492000)/(x2 - 600*r + y2 + 459600)) + 180.0
    t4 = 2*math.atan((math.sqrt((600*r - x2 - y2 + 492400)*(x2 - 600*r + y2 + 179100)) - 790*r + 237000)/(x2 - 600*r + y2 + 392400)) + 90.0
